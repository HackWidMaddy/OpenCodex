...
mod tests {
    ...
    #[test]
    fn nvidia_nim_provider_returns_no_account_state_without_env_key() {
        let mut provider_info = ModelProviderInfo::create_nvidia_nim_provider();
        provider_info.env_key = Some("CODEX_TEST_MISSING_NVIDIA_API_KEY".to_string());
    ...
    #[test]
    fn nvidia_nim_provider_disables_openai_hosted_capabilities() {
        let provider = create_model_provider(
